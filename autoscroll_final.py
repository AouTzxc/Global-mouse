...
import time
import threading
import ctypes  # [新增] 用于修复任务栏图标
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                             QHBoxLayout, QLabel, QFrame, QSlider, QDoubleSpinBox, 
                             QPushButton, QDialog, QGraphicsDropShadowEffect, QGridLayout)
from PyQt5.QtCore import Qt, pyqtSignal, QObject, QTimer
from PyQt5.QtGui import QColor, QPainter, QPen, QFont, QPainterPath, QIcon # [新增] QIcon
from pynput import mouse

# --- [关键修复 1] 资源路径定位函数 ---
# PyInstaller 打包成单文件后，文件会被解压到临时目录 sys._MEIPASS
# 这个函数能保证无论是在编辑器里运行，还是打包后运行，都能找到 logo.ico
...
class HelpDialog(QDialog):
    def __init__(self, parent=None):
        ...
        content.setText("""
            <p><b>🚀 加速度 (指数)</b><br>控制加速的猛烈程度。<br>1.0 平稳 -> 3.0 极速</p>
            <p><b>⚡ 基础速度</b><br>全局滚动的快慢倍率。</p>
            <p><b>🎯 误触死区</b><br>点击处周围不触发滚动的范围。</p>
            <p><b>📏 UI 大小</b><br>调节屏幕上箭头图标的尺寸。</p>
        """)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Smooth Scroll")
    ...
    def init_ui(self):
        ...
        footer_link.setText("""
            <a href='https://github.com/AouTzxc/Global-mouse' 
               style='color: #8E8E93; text-decoration: none; font-weight: bold; font-family: Segoe UI;'>
               By: 阿呆
            </a>
        """)
            ...
            if cfg.active:
                try:
                    ...
                    if dist > cfg.dead_zone:
                        current_dir = 'up' if dy < 0 else 'down'
...
if __name__ == "__main__":
    # --- [关键修复 3] 修复任务栏图标堆叠问题 ---
    # Windows 默认会把 Python 脚本归类为 "Python"，导致任务栏显示 Python 图标
    # 我们设置一个唯一的 AppID，告诉 Windows 这是一个独立的程序
    myappid = 'adai.smoothscroll.ios.v2.0' 
